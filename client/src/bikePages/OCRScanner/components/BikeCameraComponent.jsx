        ...
        <div className="relative w-full max-w-2xl mx-auto">
            ...
            <div className="flex justify-center gap-3 mt-4 flex-wrap">
                <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl font-bold flex items-center gap-2"
                >
