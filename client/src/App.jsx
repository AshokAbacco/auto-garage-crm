...
import BookingPopupProvider from "./providers/BookingPopupProvider";
...
function App() {
  ...
  return (
    <ThemeProvider>
      <ScrollToTop />
      <SocketProvider garageId={garageId}>
        <BookingPopupProvider>
          <Routes>
            ...
            <Route element={<WashingLayout />}>
              ...
              <Route
                path="wservices-details/:id"
                element={<WServiceDetails />}
              />
