      ...
      <>
        ...
        <footer
          className={`relative overflow-hidden ${
            isDark
              ? "footer-shiny-dark text-gray-100"
              : "footer-gradient-light text-gray-700"
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            ></div>
            <div
              className={`absolute top-3/4 right-1/4 w-1 h-1 rounded-full ${
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 relative z-10">
            ...
            <div
              className={`pt-6  flex flex-col justify-between items-center space-y-3 gap-3 md:space-y-0`}
            >
              <p
                className={`text-sm ${
              ...
              >
                © {new Date().getFullYear()} The Motor Desk. All rights reserved.
              </p>
              <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                ...
                <Link
                  to="/referencet&c"
                  className={`policy-link text-sm font-medium px-2 py-1 rounded ${
                    isDark
